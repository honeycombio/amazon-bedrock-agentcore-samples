...
### Honeycomb
- API key from Honeycomb dashboard
- Traces are routed to a dataset automatically based on the `service.name` OTEL attribute
...
- [Honeycomb Documentation](https://docs.honeycomb.io/send-data/opentelemetry/)
